import { useEffect, useState } from "react";
  ...
  return (
    ...
    <nav className={`fixed inset-0 flex items-center justify-between w-full h-[90px] px-20 z-50 transition-all duration-300 ${scrolled ? "bg-white shadow" : "bg-white bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-10"}`}>
      ...
      <div className="flex items-center gap-4">
        ...
        {/* Menu */}
        <div className="hamburger_menu max-[1300px]:flex hidden justify-center items-center p-2 rounded-xl hover:bg-white hover:bg-opacity-10 transition-all duration-300 cursor-pointer" onClick={() => setToggleMenu(!toggleMenu)}>
          {toggleMenu ?
            <svg xmlns="http://www.w3.org/2000/svg" className="text-white" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
            :
            <svg xmlns="http://www.w3.org/2000/svg" className="text-white" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="4" x2="20" y1="12" y2="12"/><line x1="4" x2="20" y1="6" y2="6"/><line x1="4" x2="20" y1="18" y2="18"/></svg>
          }
        </div>
      </div>
