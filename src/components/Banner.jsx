  ...
  return (
    <div className="w-full h-[calc(100vh-150px)] relative">
      ...
      <div className="absolute inset-0 z-50 bg-slate-400/85">
        ...
        {/* Banner content */}
        <div className="relative w-full h-full flex justify-between items-center px-20 gap-10 text-white bg-gradient-to-b from-transparent to-black/80">

          <div className="w-full xl:w-1/2 lg:w-1/2 flex flex-col justify-center gap-8 relative">
            ...
            <h1 className="font-semibold capitalize max-w-full sm:max-w-[500px] md:max-w-[600px] text-balance text-2xl sm:text-3xl md:text-4xl leading-snug sm:leading-normal md:leading-relaxed text-center md:text-left">Améliorez votre activité grâce à nos services de nettoyage professionnels</h1>
            <p className="text-base sm:text-lg md:text-xl leading-6 sm:leading-7 md:leading-8 max-w-full sm:max-w-[500px] md:max-w-[600px] text-center md:text-left">Des prestations de nettoyage de haute qualité, adaptées à vos besoins. Offrez-vous un environnement éclatant sans lever le petit doigt.</p>
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="flex-1 min-w-fit px-6 py-2 bg-white text-gray-900 hover:text-sky-900 font-semibold transition-all duration-500 rounded-full">En savoir plus</button>
              <button className="flex-1 min-w-fit group/button relative inline-flex items-center justify-center gap-1 overflow-hidden rounded-full bg-blue-500/30 backdrop-blur-lg px-6 py-2 text-base font-semibold text-white z-10 transition-all duration-300 ease-in-out hover:scale-110 hover:shadow-xl hover:shadow-blue-600/50 border border-white/20">
          ...
          <div className="min-w-1/2 h-full flex justify-center items-end relative">
          ...
          <div className="absolute left-1/2 bottom-8 cursor-pointer">
