...
const Card = ({ id, title, description, badge }) => {
  ...
  return (
    ...
    >
      <div className={`content-3d ${isFlipped ? 'flipped' : ''}`}>
        <div className="back-3d">
          <div className="back-content-3d">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full p-6 text-center">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-300 mb-4">
                ...
                <span className={`transition-all duration-300 ${isFlipped ? 'text-green-400' : 'text-yellow-400'}`}>
                  Cliquez pour découvrir
                </span>
              </div>
              
              {/* Particules décoratives - Bulles de savon */}
              <div className="absolute bottom-4 left-4 w-1 h-1 bg-purple-400 rounded-full animate-pulse"></div>
              <div className="absolute top-6 right-8 w-2 h-2 bg-blue-300/60 rounded-full animate-pulse" style={{animationDelay: '0.5s'}}></div>
              <div className="absolute top-16 left-12 w-1.5 h-1.5 bg-cyan-400/70 rounded-full animate-pulse" style={{animationDelay: '1.2s'}}></div>
              <div className="absolute bottom-12 right-6 w-1 h-1 bg-indigo-300/50 rounded-full animate-pulse" style={{animationDelay: '2s'}}></div>
              <div className="absolute top-20 right-16 w-2.5 h-2.5 bg-teal-300/40 rounded-full animate-pulse" style={{animationDelay: '1.8s'}}></div>
              <div className="absolute bottom-8 left-16 w-1 h-1 bg-violet-400/60 rounded-full animate-pulse" style={{animationDelay: '0.8s'}}></div>
            </div>
          </div>
        </div>
        <div className="front-3d">
          {/* Arrière-plan avec effets */}
          <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-gray-800 to-black rounded-xl overflow-hidden">
            ...
            {/* Effet de lueur */}
            <div className="absolute inset-0 bg-gradient-to-t from-transparent via-blue-500/5 to-purple-500/10"></div>
          </div>
          ...
          <div className="relative z-10 h-full flex flex-col justify-between">
            ...
            <div className="flex justify-start mt-2 ml-2">
              <span className="badge-3d px-3 py-1 text-xs font-medium bg-gradient-to-r from-blue-500/20 to-purple-500/20 backdrop-blur-sm border border-white/10 rounded-full text-white">
                {badge}
              </span>
            </div>
            
            {/* Section description */}
            <div className="description-3d bg-black/40 backdrop-blur-md border border-white/10 rounded-xl p-4 shadow-2xl">
              ...
              <div className="flex items-center justify-center gap-2 text-xs text-gray-400">
                ...
                <span className={`transition-all duration-300 ${isHovered ? 'text-blue-400' : 'text-gray-400'}`}>
          ...
          <div className="absolute inset-0 rounded-xl border-2 border-transparent bg-gradient-to-r from-blue-500/20 via-purple-500/20 to-pink-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
        </div>
      </div>
    </div>
  )
