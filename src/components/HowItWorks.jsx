...
const HowItWorks = () => {
  return (
    <div className="flex flex-col justify-center items-center mt-8 mb-4 px-[130px] py-8 bg-blue-50">
      ...
      <div className="w-full flex flex-col justify-center items-center mt-8">
        ...
        <div className="w-full flex flex-col items-center gap-6 mt-10 relative">
          ...
          {/* Vertical line */}
          <div className="absolute top-0 left-1/2 h-full transform -translate-x-1/2 border-t-transparent border-b-transparent border-l-transparent border-r-2 border-gray-400 border-dashed z-0" />
          ...
          <div className="w-full flex justify-center gap-16 z-10">
            ...
            <div className="p-2 h-fit bg-blue-50 rounded-full">
      ...
      <div className="relative w-full h-[300px] rounded-xl border flex justify-between mt-20 px-8 py-12 text-white bg-gradient-to-b from-teal-800 to-black">
        <div className="flex flex-col justify-center gap-8 z-10">
          <div className="border-l-4 border-white pl-4">
            <h1 className="text-xl font-bold max-w-[700px]">Découvrez la Différence qu{'\''}un espace propre peut faire - Obtenez un Devis Gratuit maintenant</h1>
          </div>
          <div className="pl-4">
            <p className="text-sm max-w-[700px]">Ne laissez plus la saleté et le désordre ternir votre environnement ! Nous sommes là pour redonner vie à vos locaux et leur offrir l’éclat qu’ils méritent. Laissez-nous vous montrer comment un espace parfaitement propre peut transformer votre quotidien.</p>
          </div>
          <div className="pl-4">
