    ...
    <div className="relative w-full px-[130px] py-32 flex flex-col justify-center items-center">
      ...
      <div className="mt-16 relative grid grid-cols-4 gap-14 w-full">
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-[13px] font-normal m-0 p-0">Nous comprenons que chaque espace et chaque client est unique. C’est pourquoi nous adaptons nos services de nettoyage à vos besoins spécifiques, pour un résultat qui vous satisfait pleinement.</p>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-[13px] font-normal m-0 p-0">Notre équipe, formée et passionnée, est engagée à offrir un service fiable et de qualité. Vous pouvez compter sur notre professionnalisme et notre souci du détail à chaque intervention.</p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-[13px] font-normal m-0 p-0">Nous utilisons des produits de nettoyage respectueux de l’environnement, combinant efficacité et parfums agréables pour un espace non seulement propre, mais aussi rafraîchi par des senteurs subtiles et durables.</p>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-[13px] font-normal m-0 p-0">Nous savons nous adapter rapidement à vos besoins, vos budgets et à vos contraintes de temps. Disponibles et réactifs, nous faisons de votre satisfaction notre priorité.</p>
        </div>
